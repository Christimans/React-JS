...
export const Checkout = () => {
  ...
  const {itemCart, totalCart} = useCarritoContext ()
    ...
    const haldleSubmit = (e) => {
      e.preventDefault()
      const items = itemCart.map(e=>{return {id:e.id, nombre:e.nombre, precio:e.precio, cantidad:e.cantidad}})
      const dia = new Date()
  ...
  return (
    <div>
      ...
      <Form onSubmit={haldleSubmit}>
        <Form.Group className="mb-3" controlId="formBasicEmail" value={Nombre} onChange={handleInputChange}>
          <Form.Label>Nombre</Form.Label>
          <Form.Control type="text" placeholder="Nombre" />
        </Form.Group>
        <Form.Group className="mb-3" controlId="formBasicEmail" value={Email} onChange={handleInputChange}>
          <Form.Label>Email</Form.Label>
          <Form.Control type="email" placeholder="Enter email" />
        </Form.Group>
        <Form.Group className="mb-3" controlId="formBasicEmail" value={Telefono} onChange={handleInputChange}>
